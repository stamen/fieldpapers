    ...
    <div class="container">
        {if $print.composed}
            ...
            <div id="atlas-export-column">
                ...
                <h4>Edit In...</h4>
                <ul id="editors">
                    <li><a href="http://www.openstreetmap.us/iD/release/#background=custom:http://fieldpapers.org/files/scans/{$print.id}/{literal}{z}/{x}/{y}{/literal}.jpg&map={$zoom}/{$print.longitude}/{$print.latitude}" target="_blank">iD</a></li>
                    <li><a href="http://www.openstreetmap.org/edit?lat={$print.latitude}&lon={$print.longitude}&zoom={$zoom}&tileurl=http://fieldpapers.org/files/scans/{$print.id}/$z/$x/$y.jpg" targtet="_blank">Potlatch</a></li>
                </ul>
            </div>
