...
<body>
    ...
    *}
    ...
    {if $constants.ADVANCED_COMPOSE_FORM}
        ...
        <form action="{$base_dir}/compose-print-old.php" method="post" name="uploads" style="display: none;" enctype="multipart/form-data">
            <p>
    ...
    <form action="{$base_dir}/compose-print-old.php" method="post" name="bounds" style="display: block;">
